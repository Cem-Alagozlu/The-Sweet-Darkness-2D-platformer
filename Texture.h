...
public:
	...
	void Draw(const Point2f& destBottomLeft, const Rectf& srcRect = {}, bool flipTexture = false) const;
	void Draw(const Rectf& destRect, const Rectf& srcRect = {}, bool flipTexture = false) const;
